#!/usr/bin/env node
/**
 * Use raw HTTP to set lessons collection permissions since SDK returns undefined perms.
 */
...
async function main() {
  ...
  console.log('[set-lessons-collection-perms-http] updated permissions:', json.permissions);
}
