...
export const CONFIG: AppConfig = {
  ...
  APPWRITE_ENDPOINT: (extra as any).APPWRITE_ENDPOINT || 'https://cloud.appwrite.io/v1',
  APPWRITE_PROJECT_ID: (extra as any).APPWRITE_PROJECT_ID || 'REPLACE_ME_APPWRITE_PROJECT_ID',
  APPWRITE_PLATFORM: (extra as any).APPWRITE_PLATFORM,
  APPWRITE_DATABASE_ID: (extra as any).APPWRITE_DATABASE_ID,
  APPWRITE_BUCKET_ID: (extra as any).APPWRITE_BUCKET_ID,
